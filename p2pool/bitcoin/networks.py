...
nets = dict(
    globalboosty=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='https://chainz.cryptoid.info/bsty/block.dws?',
        ADDRESS_EXPLORER_URL_PREFIX='https://chainz.cryptoid.info/bsty/address.dws?',
        TX_EXPLORER_URL_PREFIX='https://chainz.cryptoid.info/bsty/tx.dws?',
